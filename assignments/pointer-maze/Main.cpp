 ...
 * SAVING: (Used with Solution key) const std::string kYourName = "TODO: Replace this string with your name.";
 */
const std::string kYourName = "Evan Huang";

/* Change these constants to contain the paths out of your mazes. */
const std::string kPathOutOfNormalMaze = "WSESNWSSEEENSWNNEN";
